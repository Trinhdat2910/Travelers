...
<div class="card">
                <div class="card-body">
                  <div><h4 class="card-title" style=" float: left; line-height: 40px" >Danh Sách Đối Tác Dịch Vụ</h4>
                     <a href="admin/qlDoiTac/themDT"><button class="btn btn-success btn-block" style="width: 200px; float: right;" >Thêm Mới Đối Tác
                      ...
                      <tbody>
                        @foreach($doitac as $dt)
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-dark btn-fw"  href="admin/qlDoiTac/suaDT/{{$dt -> MaDoiTac}}">Edit</a>
                              <a class="btn btn-danger btn-fw" href="admin/qlDoiTac/xoaDT/{{$dt -> MaDoiTac}}">Delete</a>
                            </td>
