                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{App\khachhang::count('MaKH')}}</h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Booking</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{App\hopdong::count('MaHD')}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Total Tour</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{App\tour::count('MaTour')}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{App\user::count('MaNV')}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                ...
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="admin_asset/images/faces/face1.jpg" alt="profile image">
                      </div>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="admin_asset/images/faces/face2.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="admin_images/faces/face3.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
