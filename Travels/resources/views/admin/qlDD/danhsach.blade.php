  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="forms-sample" action="admin/qlDD/themDD" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  $('.editbtn').on('click',function(){
    ...
    $('#editform').attr('action','admin/qlDD/suaDD/'+ $(this).data("id"));
  ...
  $('.deletebtn').on('click',function(){
    ...
    $('#deleteform').attr('action','admin/qlDD/xoaDD/'+ $(this).data("id"));
