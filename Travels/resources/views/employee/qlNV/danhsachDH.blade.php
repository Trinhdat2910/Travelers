...
<div class="card">
                <div class="card-body">
                  <div><h4 class="card-title" style=" float: left; line-height: 40px" >DANH SÁCH NHÂN VIÊN</h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="employee/qlNV/themDH" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    
                      
                    <div class="form-group">
                      <label for="exampleInputName1">Họ Tên</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Họ Tên" name="TenNV">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputCity7" placeholder="Số điện thoại" name='Tel'>
                    </div>
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect9" name="Phamvi">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="forms-sample" action="employee/qlNV/suaNV" method="POST" id="editform" enctype = "multipart/form-data">
...
<script type="text/javascript">
  ...
  $('.editbtn').on('click',function(){
    ...
    $('#editform').attr('action','employee/qlNV/suaNV/'+ $(this).data("id"));
  ...
  $('.deletebtn').on('click',function(){
    ...
    $('#deleteform').attr('action','employee/qlNV/xoaNV/'+ $(this).data("id"));
