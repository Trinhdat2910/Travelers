...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="employee/qlHD/XuLyHD/{{$hopdong -> MaHD}}" method="POST" enctype='multipart/form-data'>
                  		...
                  		<table class="table table-bordered">
                  			...
                  			<tbody id="noidungCB">
                  				...
                  				<tr>
                  					...
                  					<td><input type="text" name="SLKCB[]" style="background: #ccc" min=0 class="SLKCB" onKeyPress="return isNumberKey(event)"></td>
                  					<td><input type="text" name="TotalCB[]" style="background: #ccc" readonly class="TotalCB"></td>
                  				</tr>
                  				@endforeach
                  				@endforeach
                  			</tbody>
                  		...
                  		<table class="table table-bordered">
                  			...
                  			<tbody id="noidungHT">
                  				...
                  				<tr>
                  					...
                  					<td><input type="text" name="SLKHT[]" style="background: #ccc" min=0 class="SLKHT" onKeyPress="return isNumberKey(event)"></td>

                  					<td><input type="text" name="TotalHT[]" style="background: #ccc" readonly class="TotalHT"></td>
                  				</tr>
                  				@endforeach
                  				@endforeach
                  			</tbody>
                  		...
                  		<table class="table table-bordered">
                  			...
                  			<tbody id="noidungRT">
                  				...
                  				<tr>
                  					...
                  					<td>
                  						Người Lớn <input type="text" name="SLNLRT[]" style="background: #ccc" min=0 class="SLNLRT" onKeyPress="return isNumberKey(event)"><br>
                  					Trẻ Em <input type="text" name="SLTERT[]" style="background: #ccc" min=0 class="SLTERT" onKeyPress="return isNumberKey(event)"></td>
                  					<td><input type="text" name="TotalRT[]" style="background: #ccc" readonly class="TotalRT"></td>
                  				</tr>
                  				@endforeach
                  				@endforeach
                  			</tbody>
                  		...
                  		<table class=" table-bordered">
                  			...
                  			<tbody id="noidungST">
                  				...
                  				<tr>
                  					...
                  					<td>
                  						Người Lớn <input type="text" name="SLNLST[]" style="background: #ccc" min=0 class="SLNLST" onKeyPress="return isNumberKey(event)"><br>
                  					Trẻ Em <input type="text" name="SLTEST[]" style="background: #ccc" min=0 class="SLTEST" onKeyPress="return isNumberKey(event)"></td>
                  					<td><input type="text" name="TotalST[]" style="background: #ccc" readonly class="TotalST"></td>
                  				</tr>
                  				@endforeach
                  				@endforeach
                  			</tbody>
