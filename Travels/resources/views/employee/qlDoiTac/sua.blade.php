...
<div class="card">
              <div class="card-body">
                  ...
                  @endif
                  <form class="forms-sample" action="employee/qlDoiTac/suaDT/{{ $doitac -> MaDoiTac}}" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <td><a class="removeDV btn btn-danger " style="color:#fff" href="employee/qlDoiTac/xoaDV/{{$bg -> MaGiaDV}}">
