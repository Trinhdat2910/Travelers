...
<div class="card">
                <div class="card-body">
                  <div><h4 class="card-title" style=" float: left; line-height: 40px" >DANH SÁCH TOUR MẪU</h4>
                    <a href="employee/qlTour/themTour"><button class=" btn btn-success btn-block" style="width: 200px; float: right;" >Tạo tour mới
                      ...
                      <tbody>
                        @foreach($tour as $t)
                          <tr>
                            ...
                            <a href="employee/qlTour/danhsachcttour/{{$t -> MaTour}}" >
                            ...
                            <td>
                              <a href="employee/qlTour/danhsachcttour/{{$t -> MaTour}}" ><button type="button" class=" btn-primary btn-fw" style="width: 80px; margin-bottom: 5px;" >Detail</button></a>
                              <br>
                              <a href="employee/qlTour/suaTour/{{$t -> MaTour}}"><button type="button" class="btn-dark btn-fw" style="width: 80px; margin-bottom: 5px;"  >
                          <i class="mdi mdi-cloud-download"></i>Edit</button></a>
                            <br>
                              <a href="employee/qlTour/xoaTour/{{$t -> MaTour}}"><button type="button" class=" btn-danger btn-fw" style="width: 80px; margin-bottom: 5px;" >
