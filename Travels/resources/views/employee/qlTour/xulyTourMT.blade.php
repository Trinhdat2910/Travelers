...
<div class="card">
                <div class="card-body">
                  <div><h4 class="card-title" style=" float: left; line-height: 40px" >DANH SÁCH TOUR MIỀN TRUNG</h4>
                  ...
                  @foreach(App\tour::where('MaKV',2)->get() as $t)
                  ...
                  <i class="mdi mdi-plus"></i>
                  		...
                  		<div class="collapse" id="ui-basic{{$t -> MaTour}}">
                			...
                			<li class="nav-item">
                  			<a class="nav-link" href="employee/qlTour/danhsachTour" style="float: left;">  {{ $ctt -> MaCTTour}}</a>
                  			<a href="employee/qlTour/chitiettour/{{$ct -> MaCTTour}} style="float:right; "  ><button type="button" class="btn btn-primary btn-fw" >Detail</button></a>
                			</li>
                        ...
                        @foreach(App\chitiettour::where('MaTour',$t-> MaTour)->get() as $ct)
                          <tr>
                            ...
                            <td>
                              ...
                              <br>
                              <a class="editCTTourbtn btn btn-dark btn-fw" data-id='{{ $ct -> MaCTTour }}' data-tentour='{{$t -> TenTour }}' data-ngaykh='{{$ct -> NgayKhoiHanh }}' data-ngaykt='{{$ct -> NgayKetThuc }}' data-manv='{{$ct -> MaNV }}' data-sl='{{$ct -> SL }}' data-songay="{{ $t -> SoNgay}}" style="color: white"  >
...
<script type="text/javascript">
  $(document).ready( function () {
    ...
    $('#addCTTourform').attr('action','employee/qlTour/themCTTour/'+ t);
      ...
      $('.hidett').on('click', function(){
        ...
        $('.showtt').on('click', function(){
          $('#showttModal').modal('show');
            ...
            $('#showttform').attr('action','employee/qlTour/showttCT/'+ $(this).data("ct"));
        });
