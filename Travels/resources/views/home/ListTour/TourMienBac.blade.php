...
@section('contentHome')
    <div class="slide-one-item home-slider owl-carousel">
      @foreach(App\tour::where('NoiBat',1)->where('MaKV',1) ->get() as $t)
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">Điểm Đến Khu Vực Miền Bắc</h2>
            <p class="color-black-opacity-5">Hãy Chọn Điểm Đến Tiếp Theo Của Bạn</p>
          </div>
        </div>
        <div class="row">
          @foreach(App\tour::where('TinhTrang',1)->where('MaKV',1)->get() as $t)
