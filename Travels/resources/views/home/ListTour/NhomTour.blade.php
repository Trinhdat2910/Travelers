...
@section('contentHome')
    <div class="slide-one-item home-slider owl-carousel">
    	@foreach($chitietnhomtour as $ct )
      @foreach(App\chitietnhomtour::where('MaNhomTour',$ct-> MaNhomTour)->get() as $t)
      <div class="site-blocks-cover overlay" style="background-image: url(upload/tour/{{ $t -> tour-> HinhAnh }});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              ...
              <h1 class="text-white font-weight-light">{{ $t -> tour-> TenTour}}</h1>
              <p class="mb-5">{{ $t -> tour-> TieuDe}}</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
          	@foreach($chitietnhomtour   as $t)
          	@foreach(App\chitietnhomtour::where('MaNhomTour', $t -> MaNhomTour)->limit(1)->get() as $tennhom)
            <h2 class="font-weight-light text-black">Điểm Đến Khu Vực {{ $tennhom -> nhomtour ->TenNhom }}</h2>
        ...
        <div class="row">
          @foreach($chitietnhomtour as $t)
          @foreach(App\chitietnhomtour::where('MaNhomTour', $t -> MaNhomTour)->get() as $ct)
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="home/ListTour/DetailTour/{{ $ct -> tour-> MaTour }}" class="unit-1 text-center">
              <img src="upload/tour/{{ $ct -> tour-> HinhAnh}}" alt="Image" class="img-fluid" style="height: 400px;">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">{{ number_format($ct ->tour -> Gia)}} VND</strong>
                <h3 class="unit-1-heading">{{ $ct -> tour-> TenTour}}</h3>
              </div>
            </a>
          </div>
          @endforeach
