...
class NhanVienController extends Controller
{
    ...
    public function getDanhSachNV(){
    	...
    	return view('admin.qlNV.danhsach',['user'=>$user]);
    }
    public function getDanhSachDH(){
        $user = user::where('level',2)->get();
        
        return view('admin.qlNV.danhsachDH',['user'=>$user]);
    }
    public function getThemNV(){

    	return view('admin.qlNV.them');
    }
    ...
    public function postThemNV(Request $request ){
    	...
    	$user -> save();
    	return redirect('admin/qlNV/danhsachNV') -> with('thongbao', 'Thêm Thành Công');
    }
    public function postThemDH(Request $request ){
        ...
        $user -> save();
        return redirect('admin/qlNV/danhsachDH') -> with('thongbao', 'Thêm Thành Công');
    }
    public function getEditNV($MaNV){
    	$user = user::find($MaNV);
    	return view('admin.qlNV.sua',['nhanvien'=>$nhanvien]);
    }
