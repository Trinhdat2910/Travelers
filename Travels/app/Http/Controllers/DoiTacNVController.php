...
class DoiTacNVController extends Controller
{
    public function getDanhSachDT(){
    	$doitac = doitac::where('MaTinh','!=', "")->get();
    	return view('employee.qlDoiTac.danhsach',['doitac'=>$doitac]);
    }
    public function getThemDT(){
    	
    
    	return view('employee.qlDoiTac.them');
    }
    public function getSuaDT($MaDT){
        
        $doitac = doitac::find($MaDT);
        return view('employee.qlDoiTac.sua', ['doitac'=>$doitac]);
    }
    public function postThemDT(Request $request ){
    	...
    	return redirect('employee/qlDoiTac/danhsachDT') -> with('thongbao', 'Thêm Thành Công');
    }
    public function postSuaDT(Request $request , $MaDT){
        ...
        return redirect('employee/qlDoiTac/danhsachDT') -> with('thongbao', 'Update Thành Công');
    }
    ...
    public function getXoaDT($MaDT){
        ...
        return redirect('employee/qlDoiTac/danhsachDT')->with('thongbao', 'Bạn đã xóa Thành Công');
    }
